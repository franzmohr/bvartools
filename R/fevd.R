...
#' \deqn{\omega^{OIR}_{jk, h} = \dfrac{\sum_{i = 0}^{h-1} (e_j^{\prime} \Phi_i P e_k )^2}
#' {\sum_{i = 0}^{h-1} (e_j^{\prime} \Phi_i \Sigma \Phi_i^{\prime} e_j )},}
...
#' calculated as \deqn{\omega^{GIR}_{jk, h} = \dfrac{\sigma^{-1}_{jj} \sum_{i = 0}^{h-1} (e_j^{\prime} \Phi_i \Sigma e_k )^2}
#'  {\sum_{i = 0}^{h-1} (e_j^{\prime} \Phi_i \Sigma \Phi_i^{\prime} e_j )},}
