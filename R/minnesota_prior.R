...
#' 
#' \deqn{ \left( \frac{\kappa_{0} \kappa_{1}}{l} \frac{\sigma_{i}}{\sigma_{j}} \right)^2 \ \text{for endogenous variables other than own lags,}}
#' 
#' \deqn{ \left( \frac{\kappa_{0} \kappa_{2}}{l} \frac{\sigma_{i}}{\sigma_{j}} \right)^2 \ \text{for exogenous variables,}}
#' 
#' \deqn{ (\kappa_{0} \kappa_{3})^2 \ \text{for deterministic terms,}}
#' 
