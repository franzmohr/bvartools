#' @include summary.bvecmodel.R
#'
#' @export
#' @rdname summary.bvecmodel
print.summary.bvecmodel <- function(x, digits = max(3L, getOption("digits") - 3L), ...){
  ...
  if (k == 1) {
    title_text <- paste0(title_text, "EC model")
  } else {
