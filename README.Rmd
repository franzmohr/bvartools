...
$$y_{t} = \begin{pmatrix} 0.4 & 0.3 & 0 \\ 0 & 0.6 & 0.1 \\ 0 & 0.2 & 0.2 \end{pmatrix} y_{t-1} + u_t, \ \ \text{with} \ \ u_t \sim N(0, \Sigma) \ \ \text{and} \ \ \Sigma = \begin{pmatrix} 0.09 & 0 & 0 \\ 0 & 0.09 & 0 \\ 0 & 0 & 0.09 \end{pmatrix}.$$
