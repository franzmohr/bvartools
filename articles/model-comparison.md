...
#>  Model 1 -458.5 -458.2          -463.5           -455.3
#>  Model 2 -133.3 -132.9          -140.4           -128.2
#>  Model 3 -121.4 -121.0          -129.6           -115.2
#>  Model 4 -118.8 -118.4          -128.3           -111.2
#>  Model 5 -115.6 -115.2          -126.0           -107.1
#> 
#> 
...
#> 
#>           Mean Median Quantile (2.5%) Quantile (97.5%)
#>  Model 1 929.0  929.0           842.2           1015.9
#>  Model 2 293.3  293.3           194.0            392.6
#>  Model 3 281.8  281.8           182.6            380.9
#>  Model 4 289.8  289.8           184.3            395.3
#>  Model 5 297.9  297.9           188.9            406.8
#> 
#> Periods with a pointwise log-likelihood variance above 0.4, which makes the correction of WAIC unreliable, in models 1 (7), 2 (14), 3 (22), 4 (32), 5 (36).
#> 
#> 
#> Leave-One-Out Information Criterion (LOOIC)
#> 
#>           Mean Median Quantile (2.5%) Quantile (97.5%)
#>  Model 1 929.1  929.1           842.2           1016.0
#>  Model 2 293.8  293.8           194.4            393.2
#>  Model 3 282.7  282.7           183.2            382.1
#>  Model 4 291.6  291.6           185.6            397.6
#>  Model 5 300.3  300.3           190.8            409.8
#> 
#> Influential periods, whose importance sampling is unreliable, in models 3 (1), 4 (1), 5 (4), counted as a Pareto k above 0.7.
```
