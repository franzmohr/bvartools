...
#> l.r      -0.002498654 0.02045598 0.0003734734   0.0009380368 -0.05054164
#> l.lr     -0.002775249 0.02110438 0.0003853115   0.0006605850 -0.05339489
#> l.Dp      0.009239946 0.04651781 0.0008492951   0.0019721790 -0.08252893
#> d.r.l01   0.003389352 0.03545343 0.0006472881   0.0017520944 -0.05356195
#> d.lr.l01  0.202578621 0.07661494 0.0013987910   0.0036999522  0.00000000
#> d.Dp.l01 -0.002548845 0.01088882 0.0001988017   0.0012879152 -0.04381623
#> const     0.012968736 0.02375067 0.0004336258   0.0011102930 -0.04037986
#>                    50%      97.5% Incl. prob. 
#> l.r      -0.0004160284 0.03767029   1.0000000 
#> l.lr     -0.0006078286 0.04158929   1.0000000 
#> l.Dp      0.0077881922 0.11013957   1.0000000 
#> d.r.l01   0.0000000000 0.11304485   0.1020000 
#> d.lr.l01  0.2065857662 0.34351616   0.9693333 
#> d.Dp.l01  0.0000000000 0.00000000   0.0720000 
#> const     0.0149747008 0.05598934   1.0000000 
#> 
#> Variable: lr 
#> 
#>                   Mean          SD     Naive SD Time-series SD        2.5%
#> l.r      -7.314892e-04 0.025952633 4.738281e-04   5.721513e-04 -0.06071701
#> l.lr     -8.463268e-03 0.030936850 5.648270e-04   1.643052e-03 -0.08791141
#> l.Dp      1.722778e-02 0.062409379 1.139434e-03   1.648010e-03 -0.10883931
#> d.r.l01   2.286392e-03 0.017083117 3.118936e-04   6.509040e-04  0.00000000
#> d.lr.l01  2.543608e-02 0.068193781 1.245042e-03   4.566388e-03  0.00000000
#> d.Dp.l01 -9.506516e-05 0.002314801 4.226228e-05   7.264354e-05  0.00000000
#> const    -2.154395e-02 0.043378138 7.919728e-04   1.067755e-03 -0.10600798
#>                    50%      97.5% Incl. prob. 
#> l.r      -5.783027e-05 0.05376886   1.0000000 
#> l.lr     -2.379598e-03 0.04318360   1.0000000 
#> l.Dp      1.555078e-02 0.14475878   1.0000000 
#> d.r.l01   0.000000e+00 0.04804089   0.0780000 
#> d.lr.l01  0.000000e+00 0.24977720   0.1843333 
#> d.Dp.l01  0.000000e+00 0.00000000   0.0100000 
#> const    -2.086259e-02 0.06176590   1.0000000 
#> 
#> Variable: Dp 
#> 
#>                 Mean         SD     Naive SD Time-series SD        2.5%
#> l.r       0.01551050 0.35092524 0.0064069890    0.022891321 -0.69245441
#> l.lr      0.21359443 0.30835903 0.0056298398    0.027875870 -0.37945527
#> l.Dp     -0.82804085 0.23206010 0.0042368184    0.012514884 -1.29892873
#> d.r.l01   0.48389659 0.32607282 0.0059532480    0.016788728  0.00000000
#> d.lr.l01  0.01357624 0.17896592 0.0032674556    0.004513047 -0.39130970
#> d.Dp.l01  0.01254822 0.04552313 0.0008311348    0.002353052  0.00000000
#> const     0.33472474 0.14041238 0.0025635675    0.008738602  0.06544187
#>                  50%      97.5% Incl. prob.  
#> l.r       0.02792628  0.6652067   1.0000000  
#> l.lr      0.21122375  0.8318072   1.0000000  
#> l.Dp     -0.81862910 -0.4091824   1.0000000 *
#> d.r.l01   0.52046963  1.0621197   0.8116667  
#> d.lr.l01  0.00000000  0.4803338   0.2746667  
#> d.Dp.l01  0.00000000  0.1732222   0.1430000  
#> const     0.32998103  0.6064128   1.0000000 *
#> 
#> Variance-covariance matrix:
#> 
#>               Mean           SD     Naive SD Time-series SD         2.5%
#> r_r   0.0004006287 0.0006519833 1.190353e-05   4.643144e-05 3.908238e-07
#> r_lr  0.0000927324 0.0001510870 2.758459e-06   1.076273e-05 7.384997e-08
#> r_Dp  0.0004687951 0.0007442306 1.358773e-05   5.572635e-05 4.244548e-07
#> lr_lr 0.0026949518 0.0011332436 2.069010e-05   9.061756e-05 9.806436e-04
#> lr_Dp 0.0029027804 0.0017870810 3.262749e-05   9.990530e-05 2.311158e-04
#> Dp_Dp 0.0511828476 0.0184742867 3.372928e-04   1.009279e-03 2.414547e-02
#>                50%        97.5%  
#> r_r   1.884831e-04 0.0020620257 *
#> r_lr  4.002893e-05 0.0004874886 *
#> r_Dp  2.101437e-04 0.0024302265 *
#> lr_lr 2.525613e-03 0.0053977892 *
#> lr_Dp 2.604870e-03 0.0071282121 *
#> Dp_Dp 4.816964e-02 0.0961273539 *
```
...
#> 
#>                  Mean         SD     Naive SD Time-series SD         2.5%
#> l.r      -0.024727489 0.03063389 0.0005592958    0.003479470 -0.101048536
#> l.lr     -0.030201496 0.03017514 0.0005509201    0.003084038 -0.104114477
#> l.Dp      0.115201420 0.06266083 0.0011440250    0.002585367 -0.001300008
#> d.r.l01   0.003408164 0.03553712 0.0006488161    0.001757510 -0.048960191
#> d.lr.l01  0.202567497 0.07671751 0.0014006637    0.003703166  0.000000000
#> d.Dp.l01 -0.002615366 0.01113142 0.0002032310    0.001388843 -0.044910971
#> const    -0.021736091 0.06560893 0.0011978497    0.005818083 -0.149932518
#>                  50%      97.5% Incl. prob. 
#> l.r      -0.01831887 0.02067567   1.0000000 
#> l.lr     -0.02464811 0.01464793   1.0000000 
#> l.Dp      0.11307566 0.24326960   1.0000000 
#> d.r.l01   0.00000000 0.11362155   0.1020000 
#> d.lr.l01  0.20650861 0.34236350   0.9693333 
#> d.Dp.l01  0.00000000 0.00000000   0.0720000 
#> const    -0.02189295 0.10821392   1.0000000 
#> 
#> Variable: lr 
#> 
#>                   Mean          SD     Naive SD Time-series SD        2.5%
#> l.r      -7.022402e-03 0.012573656 2.295625e-04   7.716274e-04 -0.03656391
#> l.lr     -1.036862e-02 0.014801274 2.702330e-04   1.294448e-03 -0.04649749
#> l.Dp      3.745882e-02 0.036910212 6.738852e-04   7.855834e-04 -0.03290696
#> d.r.l01   2.377112e-03 0.016936882 3.092237e-04   6.487778e-04  0.00000000
#> d.lr.l01  2.553780e-02 0.068357597 1.248033e-03   4.595080e-03  0.00000000
#> d.Dp.l01 -9.806079e-05 0.002361541 4.311564e-05   6.406874e-05  0.00000000
#> const    -9.201111e-03 0.036213469 6.611645e-04   1.367843e-03 -0.08113406
#>                   50%      97.5% Incl. prob. 
#> l.r      -0.004546849 0.01435386   1.0000000 
#> l.lr     -0.006911344 0.01117245   1.0000000 
#> l.Dp      0.037284501 0.10924475   1.0000000 
#> d.r.l01   0.000000000 0.05234066   0.0780000 
#> d.lr.l01  0.000000000 0.25437243   0.1843333 
#> d.Dp.l01  0.000000000 0.00000000   0.0100000 
#> const    -0.009138791 0.06249934   1.0000000 
#> 
#> Variable: Dp 
#> 
#>                 Mean         SD     Naive SD Time-series SD        2.5%
#> l.r       0.19829265 0.19696738 0.0035961158    0.023079824 -0.19371389
#> l.lr      0.27701483 0.21458603 0.0039177870    0.037041415 -0.09939393
#> l.Dp     -1.02426330 0.17632114 0.0032191688    0.008967970 -1.40841504
#> d.r.l01   0.48364279 0.32604041 0.0059526562    0.016782942  0.00000000
#> d.lr.l01  0.01357996 0.17894439 0.0032670627    0.004513039 -0.39392692
#> d.Dp.l01  0.01261751 0.04563327 0.0008331458    0.002300732  0.00000000
#> const     0.01258847 0.29199929 0.0053311533    0.049141454 -0.57819240
#>                  50%      97.5% Incl. prob.  
#> l.r       0.20618031  0.5638109   1.0000000  
#> l.lr      0.26190785  0.7212998   1.0000000  
#> l.Dp     -1.01661609 -0.6978181   1.0000000 *
#> d.r.l01   0.52073128  1.0673605   0.8116667  
#> d.lr.l01  0.00000000  0.4815487   0.2746667  
#> d.Dp.l01  0.00000000  0.1736515   0.1430000  
#> const     0.03404646  0.5515325   1.0000000  
#> 
#> Variance-covariance matrix:
#> 
#>              Mean          SD     Naive SD Time-series SD        2.5%
#> r_r   0.027415701 0.017852707 3.259444e-04   0.0006748980 0.007492173
#> r_lr  0.006194967 0.004368520 7.975789e-05   0.0001599025 0.001376332
#> r_Dp  0.032525923 0.024160024 4.410997e-04   0.0011223228 0.007088188
#> lr_lr 0.003870373 0.001551034 2.831788e-05   0.0001294902 0.001787518
#> lr_Dp 0.009884457 0.006179528 1.128222e-04   0.0002391376 0.002994233
#> Dp_Dp 0.164531632 0.053639847 9.793251e-04   0.0042006867 0.087772035
#>               50%       97.5%  
#> r_r   0.023089770 0.073534158 *
#> r_lr  0.005170804 0.017456977 *
#> r_Dp  0.026819258 0.092845246 *
#> lr_lr 0.003550990 0.007686343 *
#> lr_Dp 0.008373436 0.025435736 *
#> Dp_Dp 0.156124730 0.288342413 *
```
...
the sample, while its median rises from about -0.04 to zero: whatever
