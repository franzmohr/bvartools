...
#ifndef BAYESTS_VAR_TVP_GAMMA_H
#define BAYESTS_VAR_TVP_GAMMA_H
...
/// on the error precisions, an optional time-varying covariance block and BVS
/// variable selection.
///
...
public:
    ...
    /// of.
    arma::mat predictive_log_density(const VarTvpGammaInput &input,
                                     const VarTvpGammaDraws &draws) const;
};

} // namespace bayests

#endif // BAYESTS_VAR_TVP_GAMMA_H
