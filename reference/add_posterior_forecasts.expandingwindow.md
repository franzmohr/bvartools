...
Calculates and adds forecasts to the elements of an object of class
'expandingwindow'.
...
add_posterior_forecasts(object, ..., cores = 1)
```
...
- object:
  ...
  an object of class 'expandingwindow', usually, the result of a call to
...
The object in `object` with forecast draws added to each of its models,
as described in
