...
#> invest.l1 -0.3176638 0.1264314 0.001788010    0.001788010 -0.5625857 -0.3172985
#> income.l1  0.1485968 0.5658257 0.008001984    0.008046275 -0.9846626  0.1627844
#> cons.l1    0.9640524 0.6756543 0.009555195    0.009555195 -0.4082962  0.9687384
#> invest.l2 -0.1600478 0.1252962 0.001771956    0.001771956 -0.4008769 -0.1597934
#> income.l2  0.1148167 0.5451537 0.007709637    0.007709637 -0.9386536  0.1103539
#> cons.l2    0.9424856 0.6709273 0.009488345    0.009488345 -0.3655568  0.9389485
#> const     -1.7097287 1.7642066 0.024949649    0.024949649 -5.1666185 -1.7006067
#>                 97.5%  
#> invest.l1 -0.06512363 *
#> income.l1  1.27466072  
#> cons.l1    2.25156511  
#> invest.l2  0.08418013  
#> income.l2  1.18615926  
#> cons.l2    2.26149496  
#> const      1.76177069  
#> 
#> Variable: income 
...
#> invest.l1  0.04431364 0.03334647 0.0004715903   0.0004715903 -0.01998373
#> income.l1 -0.15278987 0.14296744 0.0020218650   0.0020218650 -0.43221286
#> cons.l1    0.28698397 0.17006376 0.0024050647   0.0024050647 -0.04539914
#> invest.l2  0.05060276 0.03259644 0.0004609832   0.0004779923 -0.01321269
#> income.l2  0.02187077 0.13968417 0.0019754325   0.0019754325 -0.25552054
#> cons.l2   -0.01662941 0.17303684 0.0024471105   0.0023062270 -0.35126234
#> const      1.58452645 0.44551149 0.0063004839   0.0064486856  0.70776174
#>                   50%     97.5%  
#> invest.l1  0.04403269 0.1116388  
#> income.l1 -0.15369277 0.1299174  
#> cons.l1    0.28675226 0.6098797  
#> invest.l2  0.05018654 0.1144229  
#> income.l2  0.02483612 0.2908569  
#> cons.l2   -0.01695750 0.3309391  
#> const      1.58001102 2.4506725 *
#> 
#> Variable: cons 
#> 
#>                   Mean         SD     Naive SD Time-series SD         2.5%
#> invest.l1 -0.001912457 0.02663874 0.0003767287   0.0003767287 -0.053425368
#> income.l1  0.225023600 0.11435036 0.0016171582   0.0016171582 -0.001476671
#> cons.l1   -0.264390446 0.13709557 0.0019388242   0.0018772379 -0.529201570
#> invest.l2  0.033868708 0.02603682 0.0003682163   0.0003797974 -0.017776166
#> income.l2  0.355903461 0.11007286 0.0015566653   0.0015566653  0.138180192
#> cons.l2   -0.026797046 0.13874053 0.0019620874   0.0019163063 -0.305505140
#> const      1.297583557 0.35774740 0.0050593123   0.0050593123  0.579210864
#>                   50%       97.5%  
#> invest.l1 -0.00243101 0.050104058  
#> income.l1  0.22360339 0.448296548  
#> cons.l1   -0.26779088 0.003986299  
#> invest.l2  0.03409113 0.085350368  
#> income.l2  0.35526084 0.572251768 *
#> cons.l2   -0.02651101 0.248743850  
#> const      1.30325919 1.987655721 *
#> 
#> Variance-covariance matrix:
#> 
#>                     Mean        SD    Naive SD Time-series SD       2.5%
#> invest_invest 22.3221594 4.1088202 0.058107493    0.069056843 15.7189942
#> invest_income  0.7443825 0.7308212 0.010335372    0.011591898 -0.6029887
#> invest_cons    1.2795592 0.6029931 0.008527610    0.009369176  0.1977631
#> income_income  1.4374210 0.2656800 0.003757283    0.004179242  1.0070534
#> income_cons    0.6441621 0.1719402 0.002431601    0.002665474  0.3563998
#> cons_cons      0.9326772 0.1707161 0.002414290    0.002706776  0.6563013
#>                      50%     97.5%  
#> invest_invest 21.8640190 31.910877 *
#> invest_income  0.7187280  2.285501  
#> invest_cons    1.2431243  2.605514 *
#> income_income  1.4052098  2.050536 *
#> income_cons    0.6241278  1.033163 *
#> cons_cons      0.9151523  1.328400 *
```
