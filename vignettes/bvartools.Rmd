...
#> invest.l1 -0.3198241 0.1296199 0.001833102    0.001833102 -0.5770526 -0.3208255
#> income.l1  0.1552746 0.5453416 0.007712294    0.007939730 -0.9386030  0.1597705
#> cons.l1    0.9440365 0.6788299 0.009600104    0.009600104 -0.3741966  0.9481831
#> invest.l2 -0.1593892 0.1263516 0.001786881    0.001786881 -0.4149325 -0.1591083
#> income.l2  0.1157560 0.5458640 0.007719682    0.007719682 -0.9491517  0.1229473
#> cons.l2    0.9168997 0.6845353 0.009680791    0.009680791 -0.4173471  0.9118107
#> const     -1.6277095 1.7563957 0.024839186    0.026119341 -5.1297230 -1.6240113
#>                 97.5%  
#> invest.l1 -0.06846830 *
#> income.l1  1.21705337  
#> cons.l1    2.25570692  
#> invest.l2  0.09169813  
#> income.l2  1.17409400  
#> cons.l2    2.28752065  
#> const      1.77657558  
#> 
#> Variable: income 
...
#> invest.l1  0.04469303 0.03222470 0.0004557261   0.0004667816 -0.01747975
#> income.l1 -0.15345385 0.14122727 0.0019972551   0.0019972551 -0.43034340
#> cons.l1    0.28919081 0.17421169 0.0024637254   0.0024637254 -0.05342469
#> invest.l2  0.05103638 0.03248906 0.0004594647   0.0004594647 -0.01525926
#> income.l2  0.02210978 0.13960832 0.0019743598   0.0019743598 -0.25009515
#> cons.l2   -0.01152956 0.17294065 0.0024457501   0.0022678250 -0.35274809
#> const      1.57260542 0.44314748 0.0062670517   0.0059219392  0.69704206
#>                   50%     97.5%  
#> invest.l1  0.04424130 0.1090320  
#> income.l1 -0.15437855 0.1279585  
#> cons.l1    0.29340144 0.6309145  
#> invest.l2  0.05083580 0.1153679  
#> income.l2  0.02150801 0.3034522  
#> cons.l2   -0.01267330 0.3288210  
#> const      1.58456972 2.4617097 *
#> 
#> Variable: cons 
#> 
#>                   Mean         SD     Naive SD Time-series SD         2.5%
#> invest.l1 -0.002550097 0.02623775 0.0003710578   0.0003710578 -0.053840801
#> income.l1  0.224155826 0.11389845 0.0016107674   0.0016107674 -0.006383757
#> cons.l1   -0.262164601 0.13597576 0.0019229876   0.0019229876 -0.523855095
#> invest.l2  0.034662108 0.02622114 0.0003708229   0.0003708229 -0.017412436
#> income.l2  0.354214809 0.11059496 0.0015640489   0.0015640489  0.141242592
#> cons.l2   -0.023630359 0.13916440 0.0019680819   0.0019153993 -0.298691591
#> const      1.295789760 0.35626161 0.0050382999   0.0050382999  0.593251895
#>                    50%       97.5%  
#> invest.l1 -0.002652552 0.048511856  
#> income.l1  0.225384571 0.448173115  
#> cons.l1   -0.260714005 0.004320602  
#> invest.l2  0.034980726 0.086005851  
#> income.l2  0.353598123 0.569477498 *
#> cons.l2   -0.024050124 0.244690330  
#> const      1.298168119 1.988262996 *
#> 
#> Variance-covariance matrix:
#> 
#>                     Mean        SD    Naive SD Time-series SD       2.5%
#> invest_invest 22.2783699 3.9934118 0.056475372    0.060483949 15.6960103
#> invest_income  0.7530115 0.7277385 0.010291776    0.011342879 -0.6156115
#> invest_cons    1.2885022 0.5932798 0.008390243    0.008911261  0.2336334
#> income_income  1.4410835 0.2662628 0.003765524    0.004151984  1.0215434
#> income_cons    0.6443531 0.1702309 0.002407428    0.002712007  0.3622913
#> cons_cons      0.9356375 0.1679450 0.002375101    0.002714349  0.6631222
#>                      50%     97.5%  
#> invest_invest 21.8433114 31.286418 *
#> invest_income  0.7321740  2.234162  
#> invest_cons    1.2522800  2.587168 *
#> income_income  1.4037946  2.041411 *
#> income_cons    0.6256173  1.043007 *
#> cons_cons      0.9158002  1.317470 *
```
