...
# Generate VAR
data <- create_var_model(e1, p = 4, deterministic = "const",
...
```{r}
bvar_est <- bvar(y = data$data$train$y, x = data$data$train$x, A = draws_a[1:36,],
...
The output of `draw_posterior` is an object of class `bvarmodel`. Thus, further analytical steps can be done as described above.
